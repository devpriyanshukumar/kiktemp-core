...
module.exports = {
  ...
  datastores: {
    default: {
      ...
      url: 'postgresql://doadmin:AVNS_7hN5j4W-S6bMvsd9ycL@kiktemp-db-do-user-12537770-0.b.db.ondigitalocean.com:25060/uatdb?sslmode=require',
      schemaName: 'public',
      ssl: {
        ca: require('fs').readFileSync('ca-certificate'),
      },
    },
  },
  ...
  custom: {
    siteUrl: 'http://24.199.74.237/',
    baseUrl: 'http://24.199.74.237/',
